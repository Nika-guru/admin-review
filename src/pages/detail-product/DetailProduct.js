                        ...
                        <Space direction="vertical" size="middle" style={{ display: 'flex' }}>
                            ...
                            >
                                ...
                                <div className='form-add-item'>
                                    ...
                                    ) : (<span className='form-add-item-content'>{productInfo[0]?.detail?.totalSupply != null ? productInfo[0]?.detail?.totalSupply : 0}</span>)}
                                </div>
                                <div className='form-add-item'>
                                    ...
                                    {isEditProduct ? (
                                        ...
                                        {productInfo[0]?.detail?.maxSupply != null ? productInfo[0]?.detail?.maxSupply : 0}
                                    </span>)}
                                </div>
                                <div className='form-add-item'>

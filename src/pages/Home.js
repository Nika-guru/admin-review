                ...
                <div className="number" style={{ cursor: 'pointer' }}>
                  <Row align="middle" gutter={[24, 0]}>
                    <Col xs={18}>
                      ...
                      <Title level={3} style={{color: 'blue', textDecoration: 'underline'}} onClick={() => handleClickSearch({ type: 'token', scam: false, category : '' })}>
                ...
                <div className="number" style={{ cursor: 'pointer' }}>
                  <Row align="middle" gutter={[24, 0]}>
                    <Col xs={18}>
                      ...
                      <Title level={3} style={{color: 'blue', textDecoration: 'underline'}} onClick={() => handleClickSearch({ type: 'ico', scam: false, category: '' })}>
                ...
                <div className="number" style={{ cursor: 'pointer' }}>
                  <Row align="middle" gutter={[24, 0]}>
                    <Col xs={18}>
                      ...
                      <Title level={3} style={{color: 'blue', textDecoration: 'underline'}} onClick={() => handleClickSearch({ type: 'project', scam: false, category: '' })}>
                ...
                <div className="number" style={{ cursor: 'pointer' }}>
                  <Row align="middle" gutter={[24, 0]}>
                    <Col xs={18}>
                      ...
                      <Title level={3} style={{color: 'blue', textDecoration: 'underline'}} onClick={() => handleClickSearch({ type: 'coin', scam: false, category: '' })}>
                ...
                <div className="number" style={{ cursor: 'pointer' }}>
                  <Row align="middle" gutter={[24, 0]}>
                    <Col xs={18}>
                      ...
                      <Title level={3} style={{color: 'blue', textDecoration: 'underline'}} onClick={() => handleClickSearch({ category: 'other', scam: false, type: '' })} >
                ...
                <div className="number" style={{ cursor: 'pointer' }}>
                  <Row align="middle" gutter={[24, 0]}>
                    <Col xs={18}>
                      ...
                      <Title level={3} style={{color: 'blue', textDecoration: 'underline'}} onClick={() => handleClickSearch({ scam: true, category: '', type: '' })}>
                ...
                <div className="number" style={{ cursor: 'context-menu' }}>
                  <Row align="middle" gutter={[24, 0]}>
                    <Col xs={18}>
                      <span>Mod add</span>
                      <Title level={3}>
                        {metric?.productTypes ? new Intl.NumberFormat().format(metric?.totalProjectResearch) : 0 }
                      </Title>
                    </Col>
